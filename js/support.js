...
var infoGeneral = [
	...
	{'question':'¿Cómo reportar?', 'answer':'Para reportar algún error o problema que encuentres en el funcionamiento del vestidor o del perfil deberás enviar un email a <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com</a> con el asunto "Reporte". Ten en cuenta que, si se trata de un error de funcionamiento, es necesario que detalles el contexto que te llevó a dicho error (si quitaste una prenda, cambiaste algún filtro, etc) y cual es el error (no cargó, cargó mal algo, etc).'},
...
var infoWardrobe = [
	...
	{'question':'No puedo elegir ninguna prenda.','answer':'El vestidor se maneja con códigos que son ubicados en el enlace. Si no puedes cargar ninguna prenda comprueba que el enlace en el que te encuentres no esté corrupto. Prueba reiniciando el vestidor con el botón en la esquina superior derecha o vuelve a abrirlo haciendo <a href="wardrobe">clic aquí</a>. Si el error persiste por favor repórtalo vía email a <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com</a>'},
	...
	{'question':'¿Cómo guardo a la guardiana que cree?','answer':'Puedes guardar una imagen de tu guardiana en el perfil. Para acceder a él cuando acabes con tu guardiana, tienes que darle al botón de "Generar Perfil".'}
]
...
var infoContests = [
	...
	{'question':'Sobre la Guardiana Destacada.','answer':'La Guardiana Destacada es la única actividad que siempre estará activa y, como no hay feedback suficiente para realizar votaciones, la guardiana será elegida al azar. No habrá premios en maanas ni MO a menos que se indique lo contrario. La participación es completamente voluntaria y puedes realizar tantos aportes como gustes. Tu guardiana permanecerá en la portada mínimo una semana y el máximo dependerá de la participación que se reciba.<br><br> Para participar solo tienes que rellenar <a href="https://forms.gle/YSJezRudkF7MwEiX6" target="_blank">ESTE FORMULARIO</a>. <br><br><h4>Sobre los campos del formulario:</h4><ul><li><u>UID / Nombre de usuario:</u> Deberás ingresar sí o sí tanto tu UID como tu nombre de usuario (por ejemplo: <b>u123456 / Usuario</b>). Si es tu primer aporte, solo deberás colocar tu nombre de usuario de Eldarya. Éste no será publicado en ningún lado, pero lo necesitaré para obtener tu UID. IMPORTANTE: Solo te enviaré el UID si es tu primer aporte, de lo contrario, si no colocas tu UID, tu participación no será tomada en cuenta.</li><li><u>Código:</u> Aquí solo tienes que pegar el código para generar a tu guardiana. Este puedes obtenerlo en el perfil con el botón "Copiar código" o incluso desde la barra de direcciones. El código no debe generar ningún error, pero si le das a copiar y pegar no tienes de qué preocuparte.</li><li><u>Correo electrónico:</u> Este campo solo será necesario si es tu primer aporte, aunque no es obligatorio. Ten en cuenta que sin él yo no podré enviarte tu UID y no podrás volver a participar hasta que tu guardiana sea elegida y lo veas en la página. Así que tú decides.</li></ul><br>Por cualquier duda o problema que tengas siempre puedes consultarme en el blog o escribiéndome a <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com</a>. ¡No dudes en escribirme si olvidas o pierdes tu UID!'},
	{'question':'¿Qué es el "UID"? ¿Cómo obtengo el mío?', 'answer':'El UID es literalmente el ID de usuario. La única manera de obtener tu UID es ganando en alguna actividad. Si participas en la "Guardiana Destacada", podrás recibir tu UID siempre y cuando dejes tu dirección de correo electrónico en el formulario correspondiente.'},
