...
var infoContests = [
	{'question':'Información general.','answer':'Los actividades realizadas en el blog son única y exclusivamente realizadas por mí (o algún voluntario) y para ustedes. Estas se realizarán periódicamente y sin fechas específicas.<br><br><u>NOTA</u>: Aunque las actividades se realizarán en blog, he creado una <a href="https://www.facebook.com/GardieMaker-649165549032593" target="_blank" title="GardieMaker">página de Facebook</a> para que la participación en dichas actividades sea más segura. Ve a darle amor para animarme a iniciarlas cuanto antes ❤'},
	...
	{'question':'¿Qué es el "UID"? ¿Cómo obtengo el mío?', 'answer':'El UID es literalmente el ID de usuario. La única manera de obtener tu UID es ganando en alguna actividad. Si tu guardiana es la "Guardiana Destacada" te pediré tu nombre de usuario de Eldarya para obtenerlo y publicarlo en el home, de lo contrario no será necesario.'},
	{'question':'¿Cómo reclamo mi premio?','answer':'Si resultas ser el ganador de alguna de las actividades, podrás reclamar tu premio via Facebook o enviando un email a <a href="mailto:gardiemaker@gmail.com">gardiemaker@gmail.com</a>. En el mensaje deberás especificar los datos según el tipo de premio, ya sea usuario y contraseña temporal (para la compra de codes) u horarios para coordinar en el mercado.<br><br> Si tienes alguna duda al respecto siempre puedes consultar primero, ya sea vía email, Facebook o dejando un comentario en el blog.'},
